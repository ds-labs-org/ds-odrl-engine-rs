    ...
    pub fn example() -> Self {
        Self {
            ...
            claims: vec![
                ...
                ClaimRow {
                    key: "nationality".to_string(),
                    value: "DE".to_string(),
                    is_list: false,
                },
                ClaimRow {
                    key: "scope".to_string(),
                    value: "catalog:read, sparql:read".to_string(),
                    is_list: true,
                },
            ],
        }
...
fn parse_action_token(token: &str) -> wire::WireActionDecl {
    match token.split_once("->") {
        Some((child, parent)) => wire::WireActionDecl {
            ...
            included_in: Some(wire::WireNodeRef {
                id: parent.trim().to_string(),
            }),
        },
        None => wire::WireActionDecl {
